        ...
        <div className="pt-list-item__title">
          <h2 className="gtm-announcement">
            <a href="https://pantip.com/s/b1j23" target="_blank">
              🎧 <strong>Pantip Daily Podcast</strong> 🎧 3 อันดับกระทู้ฮิตบนพันทิป ประจำวันที่ 10 กรกฎาคม 📊
            </a>
          </h2>
        </div>
      </li>
        ...
        <div className="pt-list-item__title">
          <h2 className="gtm-announcement">
            <a href="https://pantip.com/s/YXQM8" target="_blank">
              <strong>Pantip Point 💰</strong> น้องเพี้ยนชวนแชร์ภาพไอเทมรับหน้าฝน ที่ต้องพกติดกระเป๋า! 🌧️💧☂️
            </a>
          </h2>
        </div>
      </li>
        ...
        <div className="pt-list-item__title">
          <h2 className="gtm-announcement">
            <a href="https://pantip.com/s/KbSXE" target="_blank">
              เตรียมวอร์มมือกันได้เลย กับโบนัสพิเศษเพื่อต่อลมหายใจใน <strong>เกมบอล 2024</strong> ⚽
            </a>
          </h2>
        </div>
      </li>
